...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standard: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', 'Forme Clause', 'Nickname Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod',
			'Min Source Gen = 9',
		],
	},
	standardnext: {
		...
		ruleset: [
			'+Unreleased', 'Forme Clause', 'Nickname Clause', 'HP Percentage Mod', 'Cancel Mod',
		],
		banlist: ['Soul Dew'],
	},
	flatrules: {
	...
	standardoms: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', 'Overflow Stat Mod',
	...
	standardnatdex: {
		...
		ruleset: [
			'Obtainable', '+Unobtainable', '+Unreleased', '+Past', 'Sketch Post-Gen 7 Moves', 'Team Preview', 'Nickname Clause', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', '+Lilligant-Hisui', '+Samurott-Hisui', '+Basculegion', '+Arcanine-Hisui', '+Braviary-Hisui', '+Decidueye-Hisui', '+Electrode-Hisui', '+Goodra-Hisui', '+Qwilfish-Hisui', '+Typhlosion-Hisui', '+Overqwil', '+Wyrdeer', '+Kleavor', '+Avalugg-Hisui', '+Venusaur-Gmax',
		],
		unbanlist: ['Adamant Crystal', 'Griseous Core', 'Lustrous Globe', 'Bleakwind Storm', 'Lunar Blessing', 'Mystical Power', 'Sandsear Storm', 'Wildbolt Storm', 'Power Shift', 'Chloroblast', 'Raging Fury', 'Springtide Storm', 'Mountain Gale', 'Psyshield Bash', 'Dire Claw', 'Esper Wing', 'Take Heart', 'Victory Dance'],
		onValidateSet(set) {
			const species = this.dex.species.get(set.species);
	...
	draft: {
		...
		ruleset: [
			'Obtainable', '+Unobtainable', '+Unreleased', '+CAP', 'Sketch Post-Gen 7 Moves', 'Team Preview', 'Sleep Clause Mod', 'OHKO Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod',
		],
		// timer: {starting: 60 * 60, grace: 0, addPerTurn: 10, maxPerTurn: 100, timeoutAutoChoose: true},
	},
    draftflatrules: {
		effectType: 'ValidatorRule',
		name: 'Draft Flat Rules',
		desc: "The in-game Flat Rules: Adjust Level Down 50, Species Clause, Item Clause, -Mythical, -Restricted Legendary, Bring 6 Pick 3-6 depending on game type.",
		ruleset: ['Obtainable', '+Unreleased', '+Past', '+CAP', 'Sketch Post-Gen 7 Moves', 'Team Preview', 'Forme Clause', 'Item Clause', 'Adjust Level Down = 50', 'Picked Team Size = Auto', 'Cancel Mod'],
	},
	obtainable: {
		effectType: 'ValidatorRule',
		name: 'Obtainable',
	...
	evasionclause: {
		...
		ruleset: ['Evasion Items Clause'],
		onBegin() {
			this.add('rule', 'Evasion Clause: Evasion items, and moves are banned');
		},
	},
    ...
    evasionmovesclause: {
		...
		desc: "Bans Moves that boost Evasion",
		onBegin() {
			this.add('rule', 'Evasion Moves Clause: Moves are banned');
		},
	},
	evasionitemsclause: {
		effectType: 'ValidatorRule',
